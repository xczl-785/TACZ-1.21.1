...
当前内容与验收先读[工程入口](../../../docs/newmod/README.md)。本目录的机制说明继续用于代码核对，历史 JSON 只证明各自批次；它们不构成当前运行锁。

| 用途 | 当前入口 / 历史边界 |
| --- | --- |
| 制作十五把原生枪及附件 | [作者源](../weapon-sources/README.md)、[工具](../tools/README.md)、[全量光学](../../../docs/assembly-experiment/optics-batch/README.md) |
...
[全仓角色及保护清单](../../../docs/newmod/文档治理.md)记录旧链接和 live gate 输入；历史资料可有已删除源码引用，当前操作必须沿本页转入仍存在的入口。
