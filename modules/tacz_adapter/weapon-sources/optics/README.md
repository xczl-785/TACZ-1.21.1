...
当前已扩展到默认包全部28个光学附件定义，并按原兼容关系接入15把保留枪中的14把，共222组关系；M870保持无新增光学。所有者已于2026-09-19整体接受本轮全量交付；不虚构逐件逐组合测试记录。当前清单、操作命令、特殊类与验收表统一见[全量交付入口](../../../../docs/assembly-experiment/optics-batch/README.md)。
...
历史两件样本证据见[样本验收](../../../../docs/assembly-experiment/optics-samples/README.md)。跨引擎指导见[制作指南](../../../../../docs/进行中/瞄具制作与批量接入指南.md)，本批不开发自有枪械光学。
